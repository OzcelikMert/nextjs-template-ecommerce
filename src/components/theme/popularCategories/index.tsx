                        ...
                        <div className="carausel-6-columns" id="carausel-6-columns">
                            <div className="card-1">
                                <figure className=" img-hover-scale overflow-hidden">
                                    <a href="shop-grid-right.html"><img src="images/category-thumb-1.jpg" /></a>
                                </figure>
                                <h5><a href="shop-grid-right.html">T-Shirt</a></h5>
                            </div>
                            <div className="card-1">
                                <figure className=" img-hover-scale overflow-hidden">
                                    <a href="shop-grid-right.html"> <img src="images/category-thumb-2.jpg" /></a>
                                </figure>
                                <h5><a href="shop-grid-right.html">Bags</a></h5>
                            </div>
                            <div className="card-1">
                                <figure className=" img-hover-scale overflow-hidden">
                                    <a href="shop-grid-right.html"><img src="images/category-thumb-3.jpg" /></a>
                                </figure>
                                <h5><a href="shop-grid-right.html">Sandan</a></h5>
                            </div>
                            <div className="card-1">
                                <figure className=" img-hover-scale overflow-hidden">
                                    <a href="shop-grid-right.html"><img src="images/category-thumb-4.jpg" /></a>
                                </figure>
                                <h5><a href="shop-grid-right.html">Scarf Cap</a></h5>
                            </div>
                            <div className="card-1">
                                <figure className=" img-hover-scale overflow-hidden">
                                    <a href="shop-grid-right.html"><img src="images/category-thumb-5.jpg" /></a>
                                </figure>
                                <h5><a href="shop-grid-right.html">Shoes</a></h5>
                            </div>
                            <div className="card-1">
                                <figure className=" img-hover-scale overflow-hidden">
                                    <a href="shop-grid-right.html"><img src="images/category-thumb-6.jpg" /></a>
                                </figure>
                                <h5><a href="shop-grid-right.html">Pillowcase</a></h5>
                            </div>
                            <div className="card-1">
                                <figure className=" img-hover-scale overflow-hidden">
                                    <a href="shop-grid-right.html"><img src="images/category-thumb-7.jpg" /></a>
                                </figure>
                                <h5><a href="shop-grid-right.html">Jumpsuits</a></h5>
                            </div>
                            <div className="card-1">
                                <figure className=" img-hover-scale overflow-hidden">
                                    <a href="shop-grid-right.html"><img src="images/category-thumb-8.jpg" /></a>
                                </figure>
