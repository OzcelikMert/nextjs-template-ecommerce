                        ...
                        <div className="row align-items-center">
                            <div className="col-lg-7 mb-md-3 mb-lg-0">
                                <div className="row align-items-center">
                                    ...
                                    <div className="col my-4 my-md-0 des">
                                        <h5 className="font-size-15 ml-4 mb-0">...and receive <strong>$25 coupon for
                            ...
                            <div className="col-lg-5">
                                <form className="form-subcriber d-flex wow fadeIn animated">
                                    <input type="email" className="form-control bg-white font-small"
                ...
                <div className="container pb-20 wow fadeIn animated">
                    <div className="row">
                        ...
                        <div className="col-lg-6">
                            <p className="float-md-left font-sm text-muted mb-0">© 2022, <strong
                                className="text-brand">Evara</strong> - HTML Ecommerce Template </p>
                        </div>
                        <div className="col-lg-6">
